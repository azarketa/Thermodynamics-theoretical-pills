...
:::{warning} Important: the reversible ideal
...
:::{note} Note: relation between direct and inverse cycles
:class: dropdown
...
:::{warning} Important: features of the thermodynamic scale
...
:::{warning} Important: Carnot cycles as reference limits
